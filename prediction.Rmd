...
# Generate predictions with conditional tree model 
...
C5.0_model <- C5.0(TRAIN1, TRAIN1$complete) 
...
#Generate prediction using previously trained model
C5_prediction <- predict(C5.0_model, newdata = TEST2)

#Generate model statistics
confusionMatrix(data = C5_prediction, as.factor(TEST2$complete))
