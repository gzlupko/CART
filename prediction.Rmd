...
trainData <- createDataPartition(
  y = drop_out_distinct$complete, 
  p = 0.75, 
  list = FALSE
)

training <- drop_out_distinct[trainData, ]
testing <- drop_out_distinct[-trainData, ]
...
# fix this - ggpairs(drop_out_distinct, ggplot2::aes(colour = complete))
